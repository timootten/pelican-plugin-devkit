...
$generated = $node->getConfiguration();
...
if (is_file($configPath)) {
    ...
    if ($merged === $existing) {
        ...
        file_put_contents($configPath, Yaml::dump($merged, 6, 2, Yaml::DUMP_EMPTY_ARRAY_AS_SEQUENCE));
        info_line("patched wings config at $configPath - restart wings to apply");
    }
} else {
    file_put_contents($configPath, Yaml::dump($generated, 6, 2, Yaml::DUMP_EMPTY_ARRAY_AS_SEQUENCE));
